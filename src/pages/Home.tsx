  ...
  return (
    <PageTransition>
      <div className="flex flex-col min-h-screen pb-20 overflow-hidden">
        {/* Hero Section */}
        <section className="relative pt-8 md:pt-16 pb-24 md:pb-32 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="relative z-10 flex flex-col justify-center order-2 lg:order-1">
              <motion.div
                ...
                className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-blue-100 text-blue-800 font-bold text-sm md:text-base mb-8 border border-blue-200 shadow-sm w-fit max-w-full text-center"
              >
              ...
              <motion.h1 
                ...
                className="text-5xl sm:text-6xl md:text-7xl font-extrabold text-slate-900 mb-6 leading-[1.1] tracking-tight"
              >
                {clinicData.tagline}
              </motion.h1>
              ...
              <motion.p 
                ...
                className="text-lg sm:text-xl text-slate-600 mb-10 max-w-xl leading-relaxed"
              >
                Experience world-class dental care in a soothing, modern environment. We bring healthy, confident smiles to your entire family.
              </motion.p>
              ...
              >
                <motion.button 
                  ...
                  className="w-full sm:w-auto px-8 py-4 bg-blue-600 text-white rounded-full font-bold text-lg hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/30 cursor-pointer flex items-center justify-center"
                >
                  Book an Appointment
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                  <Link 
                    to="/services"
                    className="block w-full text-center px-8 py-4 bg-white text-slate-800 border-2 border-slate-200 rounded-full font-bold text-lg hover:border-blue-600 hover:text-blue-600 transition-colors shadow-sm"
                  >
                    Explore Services
                  </Link>
                </motion.div>
              ...
              >
                <div className="flex -space-x-4">
                  {[1, 2, 3, 4].map((i) => (
                    <img key={i} src={`https://i.pravatar.cc/100?img=${i + 10}`} alt="Patient" className="w-12 h-12 rounded-full border-4 border-white shadow-sm object-cover" />
                  ))}
                </div>
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-600">Trusted by 15k+ Patients</p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="relative z-10 order-1 lg:order-2">
              <motion.div 
                ...
                className="relative rounded-[2.5rem] md:rounded-[3.5rem] overflow-hidden shadow-2xl aspect-[4/5] lg:aspect-square"
              >
              ...
              <motion.div 
                ...
                className="absolute -top-6 -right-6 md:top-10 md:-right-10 w-20 h-20 md:w-24 md:h-24 bg-yellow-400 rounded-full flex items-center justify-center shadow-xl border-4 border-white"
              >
              ...
              <motion.div 
                ...
                className="absolute -bottom-6 -left-6 md:bottom-10 md:-left-10 bg-white p-4 md:p-6 rounded-3xl shadow-xl border border-slate-100 flex items-center gap-4"
              >
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-slate-900">Expert Doctors</p>
                </div>
              </motion.div>
            </div>
          </div>
          ...
          {/* Stats Bar */}
          <div className="relative mt-16 md:mt-24 z-20 max-w-5xl mx-auto">
            <div className="bg-white rounded-[2rem] shadow-xl border border-slate-100 p-8 md:p-10 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 relative overflow-hidden">
              ...
              {clinicData.stats.map((stat, i) => (
                ...
                >
                  ...
                  <div className="text-sm font-bold text-blue-600 uppercase tracking-wider">{stat.label}</div>
                </motion.div>
              ))}
            </div>
          </div>
              ...
              <div className="overflow-hidden relative min-h-[350px] md:min-h-[300px]">
                <AnimatePresence mode="wait">
                  <motion.div 
                    ...
                    className="bg-blue-50 p-8 md:p-12 rounded-[2rem] md:rounded-[3rem] relative mx-4 md:mx-8 mt-4 shadow-sm border border-blue-100"
                  >
                    <div className="absolute top-0 right-0 -mt-4 -mr-4 md:-mt-6 md:-mr-6 w-12 h-12 md:w-16 md:h-16 bg-yellow-400 rounded-full flex items-center justify-center shadow-lg">
                      <svg className="w-6 h-6 md:w-8 md:h-8 text-yellow-900" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                      </svg>
                    </div>
                    <div className="flex text-yellow-400 mb-6 md:mb-8">
                      {[...Array(5)].map((_, j) => <Star key={j} className="w-5 h-5 md:w-6 md:h-6 fill-current" />)}
                    </div>
                    <p className="text-slate-700 mb-8 md:mb-10 text-lg md:text-2xl italic leading-relaxed">"{testimonials[currentTestimonialIndex].text}"</p>
                    <div className="flex items-center mt-auto">
                      <div className="w-12 h-12 md:w-16 md:h-16 bg-blue-200 rounded-full flex items-center justify-center text-blue-700 font-bold text-xl md:text-2xl mr-4 md:mr-6">
                        {testimonials[currentTestimonialIndex].name.charAt(0)}
                      </div>
                      <div>
                        <p className="font-bold text-slate-900 text-lg md:text-xl">{testimonials[currentTestimonialIndex].name}</p>
                        <p className="text-slate-500 text-sm md:text-base">Verified Patient</p>
                      </div>
                    </div>
                  </motion.div>
                </AnimatePresence>
              ...
              <div className="flex justify-center mt-8 space-x-2">
                {testimonials.map((_, idx) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 cursor-pointer ${idx === currentTestimonialIndex ? 'bg-blue-600 w-8' : 'bg-blue-200 hover:bg-blue-400'}`}
